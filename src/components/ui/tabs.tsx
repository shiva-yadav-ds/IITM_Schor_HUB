...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex min-h-11 items-center justify-center rounded-full border border-border/80 bg-secondary/85 p-1 text-muted-foreground shadow-[var(--shadow-sm)]",
      className
    )}
    {...props}
  />
